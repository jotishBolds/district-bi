/*
  ...
  - The values [APPROVED,CLOSED_WITH_ACTION,COMPLETED,QUEUED] on the enum `ApplicationStatus` will be removed. If these variants are still used in the database, this will fail.
